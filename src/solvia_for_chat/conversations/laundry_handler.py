        ...
        try:
            ...
            if result_data.get("type") == "video_response":
                ...
                return {
                    ...
                    "response_text": result_data.get("response_text", "使用方法をご案内いたします"),
                    "silent_mode": result_data.get("silent_mode", False),  # 新增静默模式支持
        ...
        try:
            ...
            if config_path.exists():
                with open(config_path, 'r', encoding='utf-8') as f:
                    ...
                    # 如果明确配置了静默模式，则返回静默模式
                    if configured_mode == "silent":
                        return "silent"
                    # 如果配置了具体语言模式，则返回该模式
                    elif configured_mode in ["zh", "ja", "en"]:
